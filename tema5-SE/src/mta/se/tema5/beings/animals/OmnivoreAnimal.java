...
/**
 * represents a omnivorous animal
 * 
 * @author petru scurtu
 * @category animals
 */
public class OmnivoreAnimal implements IAnimal {
	 ...
	 */
	public OmnivoreAnimal(String name, String species) {
		super();
		this.name = name;
	...
	/**
	 * will make the animal search for plants to eat
	 */
	public void findBerries(){
		System.out.println("The "+name+" is searching for berries");
	}
